...
def create_booking(day_of_month, num_of_guests, location):
    ...
    try:
        ...
        driver.find_element(By.XPATH, "//*[@id=\"forms-agree\"]/div/div/div[1]/label").click()
        driver.find_element(By.XPATH, "//*[@id=\"forms-agree\"]/div/div/div[2]/button").click()
        time.sleep(random.randint(3, 6))
        driver.find_element(By.XPATH, "/html/body/div[1]/div/div[2]/div/div[1]/a").click()
        time.sleep(random.randint(3, 6))
